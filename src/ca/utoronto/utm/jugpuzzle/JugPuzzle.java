...
public class JugPuzzle extends Observable {
	...
	/**
	 * Return the toString method of the jug.
	 * @param n - integer, index.
	 * @return return the amount in the jug at index n
	 */
	public int getJugAmount(int n) {
		return jugs[n].getAmount();
	}
	
	/**
	 * Restart the game when called, moves resets and jugs return to their initial state.
	 */
	public void restart() {
		moves = 0;
		jugs[0].add(8);
